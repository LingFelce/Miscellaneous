---
title: "Clustering (Tamoxifen-treated samples)"
output:
...
```{r}
dds <- DESeqDataSetFromTximport(txi.tamox, metadata_tamox, ~Condition2)
```
...
annotation <- data.frame(Var1 = metadata_tamox$Condition1, Var2 = metadata_tamox$Condition2)
...
rownames(samplDistMatrix) <- metadata_tamox$Condition2
colnames(samplDistMatrix) <- metadata_tamox$Samples
...
## PCA - by timepoint and treatment
